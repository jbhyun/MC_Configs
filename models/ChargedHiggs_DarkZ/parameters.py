...
lambdaZp = Parameter(name = 'lambdaZp',
                     nature = 'external',
                     type = 'real',
                     value = 0.1,
                     texname = '\\text{lambdaZp}',
                     lhablock = 'VEC',
                     lhacode = [ 7 ])

zpv = Parameter(name = 'zpv',
                nature = 'external',
                type = 'real',
                value = 0.001,
                texname = '\\text{zpv}',
